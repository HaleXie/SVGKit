...
@implementation SVGCDNamedNodeMap
...
{
	SVGCDNode* simpleResult = [self.internalDictionary objectForKey:name];
...
-(SVGCDNode*) setNamedItem:(SVGCDNode*) arg
{
	...
	SVGCDNode* oldNode = [self.internalDictionary objectForKey:arg.localName];
...
-(SVGCDNode*) removeNamedItem:(NSString*) name
{
	...
	SVGCDNode* oldNode = [self.internalDictionary objectForKey:name];
...
{
	NSMutableDictionary* namespaceDict = [self.internalDictionaryOfNamespaces objectForKey:namespaceURI];
	SVGCDNode* oldNode = [namespaceDict objectForKey:localName];
...
-(SVGCDNode*) setNamedItemNS:(SVGCDNode*) arg inNodeNamespace:(NSString*) nodesNamespace
{
	...
	SVGCDNode* oldNode = [namespaceDict objectForKey:arg.localName];
...
{
	SVGCDNamedNodeMap* clone = [[SVGCDNamedNodeMap allocWithZone:zone] init];

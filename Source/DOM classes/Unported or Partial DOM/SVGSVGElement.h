...
@interface SVGSVGElement : SVGElement < SVGCDDocumentCSS, SVGFitToViewBox, /* FIXME: refactor and delete this, it's in violation of the spec: */ ConverterSVGToCALayer >
...
-(SVGCDNodeList*) getIntersectionList:(SVGRect) rect referenceElement:(SVGElement*) referenceElement;
-(SVGCDNodeList*) getEnclosureList:(SVGRect) rect referenceElement:(SVGElement*) referenceElement;
